...
VEHICLE_OPTIONS = {
    ...
    "light boat trailer": ["Light Boat Trailer", "Boat Trailer"],
    "large fireboat": ["Large Fireboat", "Large Coastal Boat"],
    "large rescue boat": ["Large Rescue Boat", "Large Coastal Boat"],
    "platform": ["Platform truck", "Quint"],
    "quint": ["Quint", "Platform truck"],
    "smoke jumpers": ["Smoke Jumper Vehicle", "Smokejumper Vehicle"],
    "wildland trucks": [
        "Type 3 engine",
        "Type 4 engine",
        "Type 5 engine",
